...
function slider(wrapperSelector, fieldSelector, slidesSelector) {
  ...
  console.log(width);
  var offset = 0;
  var counter = 1; // wrapper.style.width = '100%';
...
function tabs() {
  var menuTabs = document.querySelector('.expert__menu'),
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _moduls_slider__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./moduls/slider */ "./src/js/moduls/slider.js");
/* harmony import */ var _moduls_tabs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./moduls/tabs */ "./src/js/moduls/tabs.js");


$(document).ready(function () {
  (0,_moduls_slider__WEBPACK_IMPORTED_MODULE_0__.default)('.promo__slider_view', '.promo__slider_field', '.promo__slider_item');
  (0,_moduls_tabs__WEBPACK_IMPORTED_MODULE_1__.default)();
});
